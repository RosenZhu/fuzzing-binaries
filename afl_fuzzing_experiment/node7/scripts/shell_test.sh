...
inputfiles=$(ls /home/hp5_xgz/afl_fuzzing_experiment/node7/binary) # get all the test cases

for inputname in $inputfiles
do
	echo "==================================="
	echo "input name : $inputname" 
	nohup bash ./start_container.sh $inputname >> /home/hp5_xgz/afl_fuzzing_experiment/node7/log/"$inputname".log 2>&1  &	
